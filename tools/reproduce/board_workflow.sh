...
The default SHA source is the GBS build after its independent four-cell held-out
validation passed. Use frozen for the archived bundle or reproducible for the
fixed-directory source rebuild.
EOF
}
