...
STOP（历史状态）；现按周末授权完成[定向脱敏](weekend_redaction_20260911.md)，
继续完整矩阵，未通过前仍不宣告 v12 有效。历史结果保留，交付状态以新验收记录为准。
...
2026-09-15 续订正：全周期口径为 41.8% / 45.2% / 16.0%；G2 首周期 45.322245%，
全周期为 45.177290%（两周期 × 三重复 6 点）。
[逐周期输入](../data/raw/system_level_before_after_20260908/accepted_matrix/cycles.tsv)、
