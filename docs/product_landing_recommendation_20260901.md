...
> 实测收益达到预登记阈值 → 代价预算**。上文 2026-09-05 量化追注中的“通过门 C”按
...
[`B2 格证据`](../data/raw/tizen_native_evidence_20260905/cells_derived.tsv)）。同一 E4′ 的
...
按目标价值、调用频率与业务预算预登记；本报告不从现有代理数字新造统一产品阈值。
