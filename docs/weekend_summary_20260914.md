...
- 常驻守护收益很小，与同目标 enlightenment 的 272 / 36 KiB 反例同向；8–20 KiB 属官方 GST 工具进程（2026-09-15 N12-03 订正）。不证明产品收益或一般整机收益。
...
| B | 2026-09-15 N13-01 续订正：全周期口径为 41.8% / 45.2% / 16.0%，表中为 cycle=1；G2 首周期 45.322245%、全周期 45.177290%，此前 N12-07 混称撤销，数据均保留。新文档链接实查；地址前缀、CIDR 与数字误改负控在提交前修复 |
