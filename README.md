...
Frozen Demo delivery: [`demo` branch](https://github.com/lhmax2010/glibc_optimization/tree/demo) / [`demo-v8` tag](https://github.com/lhmax2010/glibc_optimization/tree/demo-v8).
